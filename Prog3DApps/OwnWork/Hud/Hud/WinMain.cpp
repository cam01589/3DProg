...
const int TexCount = 2; // How many textures we have
int Lives = 3;
float moveX = 1.5;
float moveY = 0;
float moveZ = 0;
...
ID3D11DepthStencilState			*depthDisabledStencilState; // The pointer to the depth stencil state
//ID3D11ShaderResourceView		*SpriteTextureRV = NULL;
...
//void Sprites();				  // Sprites, obviously
...
void InitGraphics()
{
    ...
    D3DX11CreateShaderResourceViewFromFile( dev,				// The Direct3D device
											L"Paddle2.tif",//Bricks.png",//heartHud.tif",	// Load Bricks.png in the local folder
...
void InitStates()
{
    ...
    bd.RenderTarget[0].SrcBlend = D3D11_BLEND_SRC_ALPHA;//D3D11_BLEND_SRC_ALPHA;
    bd.RenderTarget[0].DestBlend = D3D11_BLEND_ONE;//D3D11_BLEND_INV_SRC_ALPHA;
    bd.RenderTarget[0].BlendOpAlpha = D3D11_BLEND_OP_ADD;
    bd.RenderTarget[0].SrcBlendAlpha = D3D11_BLEND_ZERO;
    bd.RenderTarget[0].DestBlendAlpha = D3D11_BLEND_ZERO;
    bd.RenderTarget[0].RenderTargetWriteMask = 0x0f;//D3D11_COLOR_WRITE_ENABLE_ALL;
