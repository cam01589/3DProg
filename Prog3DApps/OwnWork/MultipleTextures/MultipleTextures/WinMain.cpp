...
ID3D11ShaderResourceView *pTexture[2];    // the pointer to the texture
...
void RenderFrame(void)
{
   ...
   // D3DXMATRIX matFinal[bufferSizes];
	...
	D3DXMatrixTranslation(&matTranslate[0], 1.0f, 1.0f, 1.0f );
	D3DXMatrixTranslation(&matTranslate[1], -1.5f, -1.0f, -1.0f );
