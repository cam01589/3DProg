...
void RenderFrame( void )
{
	...
	static float Time = 0.0f; Time += 0.001f;// time -= for antiClockwise rotation

	// Create a rotation matrix
	D3DXMatrixRotationY( &matRotate, Time );

	// Create a translation matrix
	D3DXMatrixTranslation( &matTranslate,0,yUp,0); 
	...
	matFinal = matTranslate * matRotate * matView * matProjection;
